...
class Cart {
	...
	addCoupun(type, price) {
		return new Promise(function (resolve) {
			...
			var query = `select setting from jeddahsp_cement.gc_settings where id = 102`
	...
	getFlatRate() {
		return new Promise(function (resolve) {
			var rate = '" + rate + "';
			var query = `select setting from jeddahsp_cement.gc_settings where id = 95`
	...
	getShippingRate() {
		return new Promise(function (resolve) {
			var rate = '" + rate + "';
			var query = `select setting from jeddahsp_cement.gc_settings where id = 116`
